...
from src.prepare_data.preference_scorers import CachedPreferenceScorer
from src.prepare_data.preference_builders import get_preference_builder
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "gen_filename", type=str, help="reletive path to generation file"
    )
    parser.add_argument(
        "comp_filename", type=str, help="reletive to reference comparison file"
    )
